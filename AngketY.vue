<template>
    <div class="container mx-auto">
        <h3 class="text-center text-xl font-bold">Variable Y</h3>
        ...
        <div class="flex flex-col p-8">
            ...
            <div class="flex flex-col">
                <p>
                    Berdasarkan skala penafsiran tersebut, maka rata-rata hitung adalah 𝑥̅ = <span class="font-bold">{{ avgSumX.toFixed(2) }}</span> berada pada klasifikasi cukup (Interval {{callScale(2)}}, - {{callScale(3)}}). Hal ini berarti xxxx yang ada di lingkungan Ponpes Al-Khoeriyyah tergolong kategori <span class="font-bold">cukup</span>
                </p>
            </div>
        </div>
    </div>
